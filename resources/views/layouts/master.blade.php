...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="http://orig15.deviantart.net/306a/f/2014/135/d/4/poro_by_adrusaurio-d7igkgb.png">
    <title>Emrah Seidov</title>
    
    <!-- Costum fonts -->
    <link href='https://fonts.googleapis.com/css?family=Lato|Raleway:400,500,600|Poiret+One' rel='stylesheet' type='text/css'/>
    
    <!-- Font Awesome -->
    <script src="https://use.fontawesome.com/613a1ea12e.js"></script>
    
    <!-- Stroke-Gap-Icons-Webfont (For scroll icon in main section) -->
